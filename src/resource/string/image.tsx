...
export const FRONTEND = [
    ...
    },
    {
      ...
      value: 40,
      className: 'bg-next',
      content: '검색최적화를 위해 SSR과 SSG를 경험해 봤어요.'
    },
    {
      stack: 'frontend',
      name: 'TypeScript',
  ...
  export const ETC = [
    ...
    },
    {
      ...
      content: 'Stoybook으로 컴포넌트 기반 UI를 개발하고 문서화 해봤어요.'
    },
    {
      stack: 'etc',
      name: 'Postman',
    ...
    },
    {
      ...
      name: 'GraphQL',
      value: 20,
      className: 'bg-graphql',
      content: 'GraphQL로 클라이언트와 서버 간의 데이터 통신을 해봤어요.'
    },
    {
      stack: 'etc',
      name: 'AWS',
